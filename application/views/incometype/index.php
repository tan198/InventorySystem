...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1>
      Manage
      <small>Income Category Type</small>
    </h1>
    <ol class="breadcrumb">
      <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
      <li class="active">Income Category Type</li>
    </ol>
  </section>
      ...
      <div class="col-md-12 col-xs-12">
        ...
        <div class="box">
          <div class="box-header">
            <h3 class="box-title">Manage Income Category Type</h3>
          </div>
          <!-- /.box-header -->
          <div class="box-body">
            <table id="manageTable" class="table table-bordered table-striped">
              <thead>
              <tr>
                <th>Income Category Type Name</th>
                <th>Action</th>
