      ...
      <div class="col-md-12 col-xs-12">
        ...
        <div class="box">
          <div class="box-header">
            <h3 class="box-title"><?php echo $this->lang->line('Edit Position')?></h3>
          </div>
          <!-- /.box-header -->
          <form role="form" action="<?php base_url('position/update') ?>" method="post" enctype="multipart/form-data">
              <div class="box-body">
				...
				<div class="form-group">
					...
					<input type="text" class="form-control" id="position_name" name="position_name" placeholder="<?php echo $this->lang->line('Enter Position Name')?>" value="<?php echo $position_data['name']; ?>"  autocomplete="off">
				</div>
              <!-- /.box-body -->
...
<script type="text/javascript">
  ...
  $(document).ready(function() {
    ...
    $("#managePositionNav").addClass('active');
