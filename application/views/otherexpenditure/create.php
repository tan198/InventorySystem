			...
			<div class="col-md-12 col-xs-12">
				...
				<div class="box">
					<div class="box-header">
						<h3 class="box-title"><?php echo $this->lang->line('Add Other Expenditure')?></h3>
					</div>

					<form role="form" action="<?php base_url('otherexpenditure/create')?>" method="post" enctype="multipart/form-data">
						<div class="box-body">
							...
							<div class="form-group">
								...
								<input type="number" pattern="^\d{1,3}(,\d{3})*(\.\d+)?" data-type="currency" name="amount" id="amount" class="form-control" autocomplete="off" />
							</div>
