...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <?php echo $this->lang->line('Manage')?>
      <small><?php echo $this->lang->line('Customer')?></small>
    </h1>
    <ol class="breadcrumb">
      <li><a href="#"><i class="fa fa-dashboard"></i> <?php echo $this->lang->line('Home')?></a></li>
      <li class="active"><?php echo $this->lang->line('Customer')?></li>
    </ol>
  </section>
    ...
    <div class="row">
      <div class="col-md-12 col-xs-12">
        ...
        <?php if(in_array('createCustomer', $user_permission)): ?>
          <button class="btn btn-primary" data-toggle="modal" data-target="#addModal"><?php echo $this->lang->line('Add Customer')?></button>
          <br /> <br />
        <?php endif; ?>

        <div class="box">
          <div class="box-header">
            <h3 class="box-title"><?php echo $this->lang->line('Manage Customer')?></h3>
          </div>
          <!-- /.box-header -->
          <div class="box-body">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title"><?php echo $this->lang->line('Add Customer')?></h4>
      </div>
      ...
      <form role="form" action="<?php echo base_url('customer/create') ?>" method="post" id="createForm">
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            <label for="name"><?php echo $this->lang->line('Customer Name')?><span class="text-danger"> *</span></label>
            <input type="text" class="form-control" id="name" name="name" placeholder="<?php echo $this->lang->line('Enter Customer Name')?>" autocomplete="off">
          </div>
			...
			<div class="form-group">
				...
				<input type="text" class="form-control" id="note" name="note" placeholder="<?php echo $this->lang->line('Enter Note')?>" autocomplete="off">
			</div>
        </div>
...
<div class="modal fade" tabindex="-1" role="dialog" id="editModal">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title"><?php echo $this->lang->line('Edit Customer')?></h4>
      </div>
      ...
      <form role="form" action="<?php echo base_url('customer/update') ?>" method="post" id="updateForm">
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            <label for="edit_name"><?php echo $this->lang->line('Customer Name')?></label>
            <input type="text" class="form-control" id="edit_name" name="edit_name" placeholder="<?php echo $this->lang->line('Enter Customer Name')?>" autocomplete="off">
          </div>
...
<div class="modal fade" tabindex="-1" role="dialog" id="removeModal">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title"><?php echo $this->lang->line('Remove Customer')?></h4>
      </div>
